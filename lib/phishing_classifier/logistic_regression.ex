defmodule PhishingClassifier.LogisticRegression do
  @moduledoc """
  Binary logistic regression trained from scratch with stochastic gradient
  descent.
  """

  alias PhishingClassifier.{Dataset, Tokenizer}
  ...
  ## Options
    ...
    * `:positive` / `:negative` - class labels (default `:phish` / `:safe`).
  """
  ...
  @doc "Per-class probability map, e.g. `%{phish: 0.91, safe: 0.09}`."
