defmodule PhishingClassifier.NaiveBayes do
  @moduledoc """
  ...
  def train(examples, opts \\ []) do
    ...
    examples = if ratio, do: PhishingClassifier.Dataset.balance(examples, ratio), else: examples
  ...
  probability (default `:phish`, threshold `0.5`).
